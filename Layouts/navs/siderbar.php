...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                    <a onclick="Index()" class="nav_link"> <i class="bx bx-grid-alt nav_icon"></i> <span class="nav_name">FORM-LSCD-012</span> </a>    
                    <a onclick="LSCD03()"  class="nav_link active"> <i class='bx bx-folder nav_icon '></i> <span class="nav_name">F-LSCD-03</span> </a> 
    ...
    <div class="height-100 bg-light">
        <div id="Index"  class="flujo" style="display: block; margin-top:90px;"><?php include_once ('./Functions/Form_LSCD-012.php')?></div>
        <div id="LSCD03"  class="flujo" style="display: none; margin-top:90px;"><?php include_once ('./Functions/F-LSCD-03.php')?></div>
